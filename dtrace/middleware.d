 ...
 * ID -> ID of the mesurement group, 802 for cowboy middleware calls.
 * Type -> Indicates of this is a entry (1) or return (2).
 * Module - The module that was called. (string).
 *
 * run with: dtrace -s middleware.d
 */
 ...
 * fiered, we filter for 802 and 1, so it gets executed when a handler
 * function is entered.
 */
